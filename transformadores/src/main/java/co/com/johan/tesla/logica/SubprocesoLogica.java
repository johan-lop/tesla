...
public class SubprocesoLogica {
     ...
     * @return 
     */
    public List<SubprocesoDTO> obtenerPorProducto(Long idProducto) {
        return convertirEntidad(persistencia.obtenerPorProducto(idProducto));
    }
    ...
    public SubprocesoDTO convertirEntidad(Subproceso entidad) {
        ...
        if (entidad.getProducto() != null) {
            dto.setProducto(new ProductoDTO(entidad.getProducto().getId()));
        }
        if (entidad.getTipoSubproceso() != null) {
            dto.setTipoSubproceso(new TipoSubprocesoDTO(entidad.getTipoSubproceso().getId()));
            dto.getTipoSubproceso().setDescripcion(entidad.getTipoSubproceso().getDescripcion());
        }
